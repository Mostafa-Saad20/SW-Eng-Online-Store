        ...
        <div id="page_content">
            ...
            <table id='products'>
                <tr>
                    <td>
                        <div class="prod_data">
                            <img class='prod_img' src='Photos/Rasperry_pi_2.jpg' width='300' height='250'>
                            <span class="prod_name">Rasperry Pi</span>
                    ...
                    <td>
                        <div class="prod_data">
                            <img class='prod_img' src='Photos/Rasperry.jpg' width='300' height='250'>
                            <span class="prod_name">Rasperry-Pi</span>
                            <button class='addtofav'>❤️</button>
                            <button class='addtocart'>Add to 🛒 </button>
                            <span class="price">$15</span>
                    ...
                    <td>
                        <div class="prod_data">
                            <img class='prod_img' src='Photos/sensor.jpg' width='300' height='250'>
                            <span class="prod_name">Sensors</span>
                            <button class='addtofav'>❤️</button>
                            <button class='addtocart'>Add to 🛒 </button>
                            <span class="price">$15</span>
                        </div>
                ...
                <tr>
                    <td>
                        <div class="prod_data">
                            <img class='prod_img' src='Photos/urduino.jpg' width='300' height='250'>
                            <span class="prod_name">Arduino</span>
                            <button class='addtofav'>❤️</button>
                            <button class='addtocart'>Add to 🛒 </button>
                            <span class="price">$15</span>
                        </div>
                    ...
                    <td>
                        <div class="prod_data">
                            <img class='prod_img' src='Photos/arduino-uno-board-500x500.jpg' width='300' height='250'>
                            <span class="prod_name">Arduino-uno</span>
                            <button class='addtofav'>❤️</button>
                            <button class='addtocart'>Add to 🛒 </button>
                            <span class="price">$15</span>
                        </div>
            ...
            <div id='numbers'>
            <script>
                document.write("<a href='main.php'><button> < back </button></a>");
                
                document.write(" <a href='main_3.php'><button> next > </button></a>");
            </script>
